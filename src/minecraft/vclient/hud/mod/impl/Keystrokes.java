...
public class Keystrokes extends HudMod {
	...
	public static class Key {
		...
		private static final Key A = new Key("A", mc.gameSettings.keyBindRight, 1, 21, 18, 18);
		private static final Key S = new Key("S", mc.gameSettings.keyBindBack, 21, 21, 18, 18);
		private static final Key D = new Key("D", mc.gameSettings.keyBindLeft, 41, 21, 18, 18);
